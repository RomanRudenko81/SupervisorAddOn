(function () {
  const TAG = 'supervisor-header-widget-v13';
  const GLOBAL = '__wxcc_header_status_v13__';
  ...
  class SupervisorHeaderWidgetV13 extends HTMLElement {
    ...
    render() {
      ...
      this.shadowRoot.innerHTML = `
        <style>
          ...
          .agent{font-size:11px;font-weight:800;max-width:30%;}
          .team{font-size:11px;font-weight:700;opacity:.96;max-width:24%;}
          .state{font-size:11px;font-weight:800;max-width:34%;}
          .sep{font-size:12px;font-weight:800;opacity:.82;}
        </style>
  ...
  if (!customElements.get(TAG)) customElements.define(TAG, SupervisorHeaderWidgetV13);
})();
