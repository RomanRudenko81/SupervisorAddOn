(function () {
  const TAG = 'supervisor-header-widget-v15';
  const GLOBAL = '__wxcc_header_status_v15__';
  ...
  class SupervisorHeaderWidgetV15 extends HTMLElement {
    ...
    render() {
      ...
      this.shadowRoot.innerHTML = `
        <style>
          ...
          .agent{font-size:14px;font-weight:800;max-width:30%;}
          .team{font-size:13px;font-weight:800;opacity:.96;max-width:24%;}
          .state{font-size:14px;font-weight:800;max-width:34%;}
          .sep{font-size:14px;font-weight:800;opacity:.84;}
        </style>
