(function () {
  const TAG = 'supervisor-header-widget-v16';
  const GLOBAL = '__wxcc_header_status_v16__';
  ...
  class SupervisorHeaderWidgetV16 extends HTMLElement {
      ...
      this.shadowRoot.innerHTML = `
        <style>
          :host{
            ...
            font-family: CiscoSans, 'Segoe UI', Arial, Helvetica, sans-serif;
            color:#fff;
          ...
          .card{
            ...
            animation: headerPulse 1.25s ease-in-out infinite;
          ...
          .agent{font-size:15px;font-weight:700;max-width:30%;}
          .team{font-size:14px;font-weight:650;opacity:.96;max-width:24%;}
          .state{font-size:15px;font-weight:700;max-width:34%;}
          .sep{font-size:15px;font-weight:650;opacity:.82;}
          @keyframes headerPulse {
            ...
            50% {
              ...
              box-shadow: 0 3px 16px ${glow}, 0 0 0 2px rgba(255,255,255,.18);
  ...
  if (!customElements.get(TAG)) customElements.define(TAG, SupervisorHeaderWidgetV15);
})();
