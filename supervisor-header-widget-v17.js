(function () {
  const TAG = 'supervisor-header-widget-v17';
  const GLOBAL = '__wxcc_header_status_v17__';
  ...
  class SupervisorHeaderWidgetV17 extends HTMLElement {
    ...
    render() {
      ...
      this.shadowRoot.innerHTML = `
        <style>
          ...
          .agent{font-size:15px;font-weight:650;max-width:30%;}
          .team{font-size:14px;font-weight:650;opacity:.96;max-width:24%;}
          .state{font-size:15px;font-weight:650;max-width:34%;}
          .sep{font-size:15px;font-weight:650;opacity:.84;}
  ...
  if (!customElements.get(TAG)) customElements.define(TAG, SupervisorHeaderWidgetV17);
})();
