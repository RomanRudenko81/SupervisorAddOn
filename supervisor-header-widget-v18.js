(function () {
  const TAG = 'supervisor-header-widget-v18';
  const GLOBAL = '__wxcc_header_status_v18__';
  ...
  class SupervisorHeaderWidgetV18 extends HTMLElement {
    ...
    render() {
      ...
      this.shadowRoot.innerHTML = `
        <style>
          ...
          .agent{font-size:15px;font-weight:500;max-width:30%;}
          .team{font-size:14px;font-weight:500;opacity:.96;max-width:24%;}
          .state{font-size:15px;font-weight:500;max-width:34%;}
          .sep{font-size:15px;font-weight:500;opacity:.84;}
  ...
  if (!customElements.get(TAG)) customElements.define(TAG, SupervisorHeaderWidgetV18);
})();
