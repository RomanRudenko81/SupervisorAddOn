(function () {
  const TAG = 'supervisor-header-widget-v20';
  const GLOBAL = '__wxcc_header_status_v20__';
  ...
  if (!customElements.get(TAG)) customElements.define(TAG, SupervisorHeaderWidgetV20);
})();
