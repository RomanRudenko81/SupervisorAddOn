(function () {
  const TAG = 'supervisor-header-widget-v8';

  class SupervisorHeaderWidgetV8 extends HTMLElement {
  ...
  if (!customElements.get(TAG)) customElements.define(TAG, SupervisorHeaderWidgetV8);
})();
