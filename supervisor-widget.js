class SupervisorAccessWidget extends HTMLElement {
  constructor() {
    ...
    this.themeMode =
      localStorage.getItem("supervisorWidgetTheme") || "light";
  }
  ...
  applyTheme() {
    ...
    const themeBtn =
      this.shadowRoot.getElementById("themeToggleBtn");
  ...
  $toggle() {
    return this.shadowRoot
      .getElementById("emergencyToggle");
  }

  $priorityQueue() {
    return this.shadowRoot
      .getElementById("priorityQueue");
  }

  $emergencyPrompt() {
    return this.shadowRoot
      .getElementById("emergencyPrompt");
  }

  $holidayPrompt() {
    return this.shadowRoot
      .getElementById("holidayPrompt");
  }
  ...
  $globalVoiceName() {
    return this.shadowRoot
      .getElementById("globalVoiceName");
  }

  $mohSalesQueue() {
    return this.shadowRoot
      .getElementById("mohSalesQueue");
  }
  ...
  applyRoleState() {
    ...
    this.$priorityQueue().disabled =
      !writable;

    this.$emergencyPrompt().disabled =
      !writable;

    this.$holidayPrompt().disabled =
      !writable;

    this.$globalLanguage().disabled =
      !writable;

    this.$globalVoiceName().disabled =
      !writable;

    this.$mohSalesQueue().disabled =
      !writable;
